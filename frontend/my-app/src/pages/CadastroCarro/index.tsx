            ...
            <View style={style.boxMid}>
                ...
                <View style={style.scroll} >
                    ...
                    <View style={style.apelido}>
                        ...
                        <Input2 value={ano} onChangeText={setAno} width={380} height={50} alignSelf="center" backgroundColor="white" placeholder="Ano do carro"></Input2>
                    </View>
                    ...
                    <View style={style.apelido}>
                        ...
                        <Input2 value={mediaKmSemana} onChangeText={setMediaKmSemana} width={380} height={50} alignSelf="center" backgroundColor="white" placeholder=" Quilometros percorridos por semana"></Input2>
                    </View>
